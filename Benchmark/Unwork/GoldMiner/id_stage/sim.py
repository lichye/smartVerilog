...
def runner():
    ...
    if not os.path.exists(working_dir+"/sim_build/ibex_register_file_ff.sv"):
        subprocess.run(["cp",dir_path+"/ibex_register_file_ff.sv",working_dir+"/sim_build/ibex_register_file_ff.sv"])
